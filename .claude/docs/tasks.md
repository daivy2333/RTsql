...
> 最后更新：2026-09-08（MS10-T03 完成并增量刷新；change 归档至 `archive/2026-09-08-2026-09-08-ms10-t03-file-format-header/`，含新增 spec `database-file-format-header`）
> 同步状态: current
...
- **Status**: planned（T01-T03 已完成，2026-09-06/2026-09-08；T04-T05 待后续 change）
- **Dependencies**: MS08
